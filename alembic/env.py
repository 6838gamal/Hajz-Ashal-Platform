...
# Import every module's ORM models so Base.metadata is complete for
# autogenerate. Each module owns its models file; this is the one place
# allowed to import all of them, since Alembic's metadata must be global.
...
from admin.platform_admin.infrastructure import models as platform_admin_models  # noqa: E402,F401
